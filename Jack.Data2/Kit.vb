Public Class Kit
    Inherits BaseData(Of Model.Kit, Integer)
    ...
    ''' <remarks></remarks>
    Overrides Function Insert(ByVal oTipo As Model.Kit) As Boolean
    ...
    ''' <returns>Boolean. Se a operação foi um sucesso, true.</returns>
    ''' <remarks></remarks>
    Overrides Function Update(ByVal oTipo As Model.Kit) As Boolean
    ...
    ''' <returns>Boolean. Se a operação foi um sucesso, true.</returns>
    ''' <remarks></remarks>
    Overrides Function Delete(ByVal oTipo As Model.Kit) As Boolean
    ...
    ''' <remarks></remarks>
    Overrides Function Find(ByVal Identifier As Integer) As Model.Kit
    ...
    ''' <remarks></remarks>
    Overrides Function LoadAll() As IList(Of Model.Kit)
