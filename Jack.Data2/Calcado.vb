Public Class Calcado
    Inherits BaseData(Of Model.Calcado, Integer)
    ...
    ''' <remarks></remarks>
    Overrides Function Insert(ByVal oTipo As Model.Calcado) As Boolean
    ...
    ''' <returns>Boolean. Se a operação foi um sucesso, true.</returns>
    ''' <remarks></remarks>
    Overrides Function Update(ByVal oTipo As Model.Calcado) As Boolean
    ...
    ''' <returns>Boolean. Se a operação foi um sucesso, true.</returns>
    ''' <remarks></remarks>
    Overrides Function Delete(ByVal oTipo As Model.Calcado) As Boolean
    ...
    ''' <remarks></remarks>
    Overrides Function Find(ByVal Identifier As Integer) As Model.Calcado
    ...
    ''' <remarks></remarks>
    Overrides Function LoadAll() As IList(Of Model.Calcado)
