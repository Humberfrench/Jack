Public Class Reuniao
    Inherits BaseData(Of Model.Reuniao, Integer)
    ...
    ''' <remarks></remarks>
    Overrides Function Insert(ByVal oTipo As Model.Reuniao) As Boolean
    ...
    ''' <returns>Boolean. Se a operação foi um sucesso, true.</returns>
    ''' <remarks></remarks>
    Overrides Function Update(ByVal oTipo As Model.Reuniao) As Boolean
    ...
    ''' <returns>Boolean. Se a operação foi um sucesso, true.</returns>
    ''' <remarks></remarks>
    Overrides Function Delete(ByVal oTipo As Model.Reuniao) As Boolean
    ...
    ''' <remarks></remarks>
    Overrides Function Find(ByVal Identifier As Integer) As Model.Reuniao
    ...
    ''' <remarks></remarks>
    Overrides Function LoadAll() As IList(Of Model.Reuniao)
